...
const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-gray-100 min-h-screen flex items-center justify-center p-6 font-sans">
      {/* Background Pattern */}
      ...
      {/* Login Card */}
      <div className="relative glass-effect rounded-3xl modern-shadow w-full max-w-md p-8 z-10">
        ...
        <div className="hidden md:block absolute -right-full top-1/2 transform -translate-y-1/2 z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center">
              <input type="checkbox" className="w-4 h-4 text-accent bg-white/80 border-gray-300 rounded focus:ring-accent focus:ring-2" />
              <span className="ml-2 text-sm text-gray-700">Remember me</span>
            </label>
            <span className="text-sm text-accent hover:text-accent/80 font-medium transition-all cursor-pointer">Forgot Password?</span>
          </div>
